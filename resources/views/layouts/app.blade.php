...
<head>
    <title>@yield('meta_title', 'FPCI UNEJ')</title>
    <meta name="description" content="@yield('meta_description', 'FPCI Universitas Jember')">
    <meta property="og:title" content="@yield('og_title', 'FPCI UNEJ')">
    <meta property="og:description" content="@yield('og_description', 'FPCI Universitas Jember')">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    @foreach($menuParents as $parent)
                        ...
                        @else
                            <li class="nav-item">
                                <a href="{{ $parent->link }}" class="nav-link {{ $isActive ? 'active' : '' }}">
                                    {{ $parent->menu_label }}
                                </a>
                            </li>
                        @endif
            ...
            <form action="{{ route('search') }}" method="GET"
                class="d-flex align-items-center search-form position-relative" id="searchForm">
                <div class="search-wrapper position-relative">
                    <i class="bi bi-search search-icon" id="searchIcon"></i>
                    <input type="text" name="q" id="searchInput" class="search-input" placeholder="Cari..."
                        autocomplete="off">
    ...
    <div class="site-lightbox" id="siteLightbox" role="dialog" aria-modal="true" aria-labelledby="lightboxTitle"
        aria-hidden="true">
        <button type="button" class="site-lightbox-close" id="lightboxClose" aria-label="Tutup gambar">&times;</button>
        <button type="button" class="site-lightbox-control site-lightbox-prev" id="lightboxPrev"
            aria-label="Gambar sebelumnya">&#10094;</button>
        <figure class="site-lightbox-figure">
            <img id="lightboxImage" src="" alt="">
            <figcaption id="lightboxTitle"></figcaption>
        </figure>
        <button type="button" class="site-lightbox-control site-lightbox-next" id="lightboxNext"
            aria-label="Gambar berikutnya">&#10095;</button>
        ...
        <div class="footer">
            <div class="container">
                <div class="row footer-row">
                    ...
                    <div class="col-md-4">
                        <img src="{{ asset($logo) }}" width="90" alt="Logo FPCI UNEJ">
                        <p>{{ $contact->alamat ?? 'Jl. Kalimantan No.37, Tegal Boto Lor, Sumbersari, Kec. Sumbersari, Kabupaten Jember, Jawa Timur 68121' }}
                        </p>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="d-flex gap-3 mt-2 flex-wrap">
                            ...
                            @if($contact && $contact->linkedin)
                                <a href="https://linkedin.com/company/{{ $contact->linkedin }}" target="_blank"
                            ...
                            @if($contact && $contact->tiktok)
                                <a href="https://tiktok.com/@{{ $contact->tiktok }}" target="_blank" class="social-icon"
                                    title="TikTok">
                            ...
                            @if($contact && $contact->youtube)
                                <a href="https://youtube.com/{{ $contact->youtube }}" target="_blank" class="social-icon"
                                    title="YouTube">
                            ...
                            @if($contact && $contact->x)
                                <a href="https://twitter.com/{{ $contact->x }}" target="_blank" class="social-icon"
                                    title="Twitter / X">
