        ...
        <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data" id="postForm">
            ...
            <div class="mb-3">
                ...
                <textarea name="meta_description" class="form-control @error('meta_description') is-invalid @enderror"
                    rows="3" placeholder="Masukkan deskripsi singkat untuk SEO">{{ old('meta_description') }}</textarea>
            ...
            <div class="mb-3">
                ...
                @if(isset($isPage) && $isPage)
                    <a href="{{ route('admin.pages.list') }}" class="btn btn-secondary">
                        <i class="bi bi-arrow-left me-1"></i> Batal - Kembali ke Halaman
                    </a>
                @else
                    <a href="{{ route('admin.posts.index') }}" class="btn btn-secondary">
                        <i class="bi bi-arrow-left me-1"></i> Batal - Kembali ke Semua Postingan
                    </a>
                @endif
