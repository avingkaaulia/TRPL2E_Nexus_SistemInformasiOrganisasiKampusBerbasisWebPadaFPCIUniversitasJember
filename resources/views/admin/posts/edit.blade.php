...
@section('content')
    <div class="admin-card">
        <form action="{{ route('admin.posts.update', $post->id_post) }}" method="POST" enctype="multipart/form-data"
            id="postForm">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <input type="text" name="meta_title" id="meta_title"
                    ...
                    placeholder="Otomatis mengikuti judul">
                @error('meta_title')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
                <small class="text-muted">
                    Meta Title otomatis mengikuti judul karya.
                </small>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="meta_description" class="form-control @error('meta_description') is-invalid @enderror"
                    rows="3"
                    placeholder="Masukkan deskripsi singkat untuk SEO">{{ old('meta_description', $post->meta_description) }}</textarea>
            ...
            <div class="mb-3">
                ...
                <select name="id_post_category" class="form-select @error('id_post_category') is-invalid @enderror"
                    required>
            ...
            <div class="mb-3">
                ...
                <div>
                    ...
                    @else
                        <div
                            style="width:150px; height:100px; background:#5C6844; border-radius:8px; display:flex; align-items:center; justify-content:center; color:white;">
                    ...
                    <div class="row">
                        @foreach($post->gallery as $gallery)
                            <div class="col-md-3 text-center mb-3">
                                <img src="{{ asset('storage/' . $gallery->image_path) }}" class="img-thumbnail"
            ...
            <div class="mb-3">
                ...
                <div id="galleryContainer">
                    <div class="gallery-item row mb-3" id="galleryItem1">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="gallery_descriptions[]" class="form-control"
            ...
            <div class="mb-3">
                ...
                <textarea id="tiny-editor" name="post_content"
    ...
    <!-- TinyMCE CDN -->
    <script src="https://cdn.tiny.cloud/1/9vwhsdy8sam8oxtsknl77ddzx28dapdx3bjig8xljsfnbge5/tinymce/6/tinymce.min.js"
        referrerpolicy="origin"></script>

    <script>
        // Auto isi Meta Title dari Judul
